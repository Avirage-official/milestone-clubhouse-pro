          ...
          <div className="relative mx-auto flex items-end justify-center">
            ...
            <div className="absolute left-0 top-8 z-20 hidden w-72 rounded-2xl border border-white/15 bg-[#1a1340]/90 p-5 shadow-2xl backdrop-blur-xl lg:block">
              ...
              <div className="mt-2 flex gap-2">
                <span className="rounded-full border border-white/10 bg-white/5 px-2.5 py-1 text-[10px] text-white/70">🕐 Monday at 3:00 PM</span>
                <span className="rounded-full border border-white/10 bg-white/5 px-2.5 py-1 text-[10px] text-white/70">🕐 Tuesday at 1:00 PM</span>
              </div>
            ...
            <div className="absolute left-[35%] top-12 z-20 hidden flex-col gap-2 rounded-2xl border border-white/15 bg-[#1a1340]/90 p-2 shadow-2xl backdrop-blur-xl lg:flex">
              {[
                "M10.394 2.08a1 1 0 00-.788 0l-7 3a1 1 0 000 1.84L5.25 8.051a.999.999 0 01.356-.257l4-1.714a1 1 0 11.788 1.838l-3.14 1.346 2.353 1.005a1 1 0 00.788 0l7-3a1 1 0 000-1.838l-7-3.001z",
